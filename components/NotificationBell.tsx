...
export default function NotificationBell({ buttonClassName = "", iconSize = 20 }: NotificationBellProps) {
  ...
  return (
    <div className="relative">
      <button
        ...
        title="Notifications"
        className={`relative inline-flex h-10 w-10 items-center justify-center rounded-xl text-slate-600 transition-colors hover:bg-sky-50 hover:text-sky-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-200 ${buttonClassName}`}
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute right-0.5 top-0.5 flex h-4 w-4 items-center justify-center rounded-full bg-red-500 text-[10px] font-semibold leading-none text-white">
